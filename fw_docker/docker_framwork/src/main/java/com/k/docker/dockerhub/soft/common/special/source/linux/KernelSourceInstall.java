package com.k.docker.dockerhub.soft.common.special.source.linux;
...
public class KernelSourceInstall extends DockerhubCallBack {

    @Override
    public void buildRegion(DockerRegionEnum region, List<DockerRun> runs) {
        String name = "sourceKernel";
        String version = "king019/source:kernel";
