package com.k.docker.dockerhub.soft.common.special.source.redis;
...
public class RedisSourceInstall extends DockerhubCallBack {

    @Override
    public void buildRegion(DockerRegionEnum region, List<DockerRun> runs) {
        String name = "sourceRedis";
        String version = "king019/source:redis";
