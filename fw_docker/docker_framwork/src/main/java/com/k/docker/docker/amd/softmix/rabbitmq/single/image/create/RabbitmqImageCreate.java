package com.k.docker.docker.amd.softmix.rabbitmq.single.image.create;
...
public class RabbitmqImageCreate extends DockerImageBase {

    @Test
    public void test() throws Exception {
        List<DockerImageBuildBase> list = Lists.newArrayList();
        list.add(new RabbitmqSingleDockerImage(RabbitmqBuild.class));
        buildList(list);
    }
}
