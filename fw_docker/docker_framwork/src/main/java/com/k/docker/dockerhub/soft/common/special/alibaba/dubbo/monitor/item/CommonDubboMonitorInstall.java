package com.k.docker.dockerhub.soft.common.special.alibaba.dubbo.monitor.item;
...
public class CommonDubboMonitorInstall extends DockerhubCallBack {
    @Override
    public void buildRegion(DockerRegionEnum region, List<DockerRun> runs) {
        String name = "dubbomonitor";
        String version = "king019/dubbo:monitor";
