package com.k.docker.dockerhub.soft.common.special.source.mysql;
...
public class MysqlSourceInstall extends DockerhubCallBack {

    @Override
    public void buildRegion(DockerRegionEnum region, List<DockerRun> runs) {
        String name = "sourceMysql";
        String version = "king019/source:mysql";
