package com.k.docker.dockerhub.soft.common.special.alibaba.sentinel.sentineldashboard.item;
...
public class CommonSentinelDashboardInstall extends DockerhubCallBack {
    @Override
    public void buildRegion(DockerRegionEnum region, List<DockerRun> runs) {
        String name = "sentinelDashboard";
        String version = "king019/sentinel:dashbord";
