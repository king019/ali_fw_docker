package com.k.docker.dockerhub.soft.common.special.source.alibaba;
...
public class NacosSourceInstall extends DockerhubCallBack {

    @Override
    public void buildRegion(DockerRegionEnum region, List<DockerRun> runs) {
        String name = "sourceNacos";
        String version = "king019/source:nacos";
